        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' placeholder='What is happening ? ' onChange={(e)=>setContent(e.target.value)} value={content} />
            ...
            <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
              <label htmlFor="images" className='flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 transition cursor-pointer'><Image className='size-6'/>
              </label>
              ...
              )} className='text-sm bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo hover:to-purple-700 active:scale-95 transition text-white font-medium px-8 py-2 rounded-md cursor-pointer'>
                Publish Post
              </button>
            </div>
        </div>

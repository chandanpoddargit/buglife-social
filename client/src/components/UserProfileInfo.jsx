            ...
            <div className='flex flex-col md:flex-row items-start gap-6'>
                ...
                <div className='w-full pt-16 md:pt-0 md:pl-36'>
                    <div className='flex flex-col md:flex-row items-start justify-between'>
                        ...
                        {/* if user is not on others profile that means he is opening his profile so well give edit button */}
                        {!profileId && 
                            <button onClick={()=>setShowEdit(true)} className='flex items-center gap-2 border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colrs mt-4 md:mt-0 cursor-pointer'>
